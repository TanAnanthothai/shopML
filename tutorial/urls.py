...
urlpatterns = [
    ...
    # url(r'^api/v1.0/get_recommendation[/]?$', sidmlapiviews.CorrelationRecommender.as_view(), name='my_rest_view'),
    url(r'^api/v1.0/get_recommendation[/]?$', sidmlapiviews.ShowAllPosRecommender.as_view(), name='my_rest_view'),
    url(r'^api/v1.0/post_recommendation/$', sidmlapiviews.post_recommendation.as_view(), name='my_rest_view')
]